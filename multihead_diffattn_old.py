...
class MultiheadDiffAttn(nn.Module):
    def __init__(
        ...
        self.q_proj = nn.Linear(embed_dim, embed_dim, qkv_bias)
        self.k_proj = nn.Linear(embed_dim, embed_dim // self.n_rep, qkv_bias)
        self.v_proj = nn.Linear(embed_dim, embed_dim // self.n_rep, qkv_bias)
